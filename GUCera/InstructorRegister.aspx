...
<body>
    <form id="form1" runat="server">
        <p>
         <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="XX-Large" ForeColor="#000066" style="padding-left:450px" Text="Instructor register"></asp:Label>
        &nbsp;</p>
    <p>
        First name:</p>
    <p>
